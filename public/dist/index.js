...
/* eslint-disable */ var _updateQuizJs = require("./updateQuiz.js");
var _createQuizJs = require("./createQuiz.js");
var _increseViewJs = require("./increseView.js");
var _loginJs = require("./login.js");
var _quizHistoryJs = require("./quizHistory.js");
var _singUpJs = require("./singUp.js");
var _deleteQuizJs = require("./deleteQuiz.js");
var _updatePasswordJs = require("./updatePassword.js");
var _updateMeJs = require("./updateMe.js");
...
main.addEventListener("click", async (e)=>{
    ...
    if (quizOption.dataset.answer === quizContainer.dataset.correct) correctAnswers++;
    ...
    if (!nextQuestion) {
        ...
        completionCard.querySelector("p").textContent = `Voc\xea completou o quiz. Acertando ${correctAnswers} perguntas de ${+index + 1}`;
        completionCard.classList.remove("hidden");
        quizContainer.classList.add("hidden");
        const quizId = main.dataset.quizid;
        const token = document.querySelector('meta[name="csrf-token"]').getAttribute("content");
        (0, _quizHistoryJs.saveOnHistory)({
            quizId,
            correctAnswers,
            totalQuestions: +index + 1
        }, token);
        (0, _increseViewJs.increseViewCount)(quizId, token);
        return;
    }
    quizContainer.classList.add("hidden");
...
if (loginForm) loginForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _loginJs.login)({
        email,
        password
    });
});
if (singupForm) singupForm.addEventListener("submit", async (e)=>{
    e.preventDefault();
    const email = document.querySelector("#email").value;
...
if (addQuestionBtn) {
    addQuestionBtn.addEventListener("click", (e)=>{
        const lastQuestionIndex = +questionContainer.lastElementChild.dataset.question;
        const markup = `
    <div class="question-group" data-question="${lastQuestionIndex + 1}">
             <span class="exclude">X</span>
                    ...
                    <div class="form-group">
                        <label for="question-${lastQuestionIndex + 2}">Question</label>
                        <input type="text" id="question-${lastQuestionIndex + 2}" name="questions[${lastQuestionIndex + 1}][question]" required>
                    </div>
                    <div class="answers-group">
                        <label>Answers</label>
                        <div class="answer">
                            <input type="text" name="questions[${lastQuestionIndex + 1}][answers][]" required>
                            <input type="radio" name="questions[${lastQuestionIndex + 1}][correct_answer]" value="0" required>
                        </div>
                        <div class="answer">
                            <input type="text" name="questions[${lastQuestionIndex + 1}][answers][]" required>
                            <input type="radio" name="questions[${lastQuestionIndex + 1}][correct_answer]" value="1" required>
                        </div>
                        <div class="answer">
                            <input type="text" name="questions[${lastQuestionIndex + 1}][answers][]" required>
                            <input type="radio" name="questions[${lastQuestionIndex + 1}][correct_answer]" value="2" required>
                        </div>
                        <div class="answer">
                            <input type="text" name="questions[${lastQuestionIndex + 1}][answers][]" required>
                            <input type="radio" name="questions[${lastQuestionIndex + 1}][correct_answer]" value="3" required>
                        </div>
                    </div>
    </div>
    `;
...
if (createQuizForm) createQuizForm.addEventListener("submit", async (e)=>{
    e.preventDefault();
    const formData = new FormData(createQuizForm);
    const token = document.querySelector('meta[name="csrf-token"]').getAttribute("content");
    const questions = [
        ...document.querySelectorAll(".question-group")
    ].map((el, i)=>{
        return {
            question: el.querySelector(`#question-${i + 1}`).value || "psefjsushdfoufs",
            answers: [
                ...el.querySelectorAll(`[name="questions[${i}][answers][]"]`)
            ].map((ans)=>ans.value || "sfjdofdj"),
            correctAnswer: +el.querySelector(`input[name="questions[${i}][correct_answer]"]:checked`)?.value || 1
        };
    });
    ...
    await (0, _createQuizJs.createQuiz)(formData);
});
...
document.addEventListener("click", (event)=>{
    ...
    if (!profileContainer.contains(event.target)) dropdownMenu.style.display = "none";
});
saveQuizBtn?.addEventListener("click", (e)=>{
    ...
    const questions = [
        ...
        return {
            ...
            correctAnswer: +el.querySelector(`input[name="questions[${i}][correct_answer]"]:checked`).value
        };
    });
    ...
    if (imageInput.files.length > 0) formData.append("imageCover", imageInput.files[0]);
    formData.append("questions", JSON.stringify(questions));
    formData.append("csrfToken", token);
    (0, _updateQuizJs.updateQuiz)(formData, id);
});
deleteQuizContainer?.addEventListener("click", (e)=>{
    ...
    confirmBtn.addEventListener("click", ()=>{
        (0, _deleteQuizJs.deleteQuiz)(id, token);
    });
...
changePasswordForm?.addEventListener("submit", (e)=>{
    ...
    (0, _updatePasswordJs.updatePassword)({
        currentPassword,
        password,
        passwordConfirm
    }, csrfToken);
...
document.querySelector(".new-photo-btn")?.addEventListener("click", (e)=>{
    ...
    if (imageInput.files.length > 0) {
        ...
        formData.append("csrfToken", token);
        (0, _updateMeJs.updateMe)(formData);
    }
});

},{"./updateQuiz.js":"aVdmn","./createQuiz.js":"7nNen","./increseView.js":"2Ax38","./login.js":"7yHem","./quizHistory.js":"hw7oM","./singUp.js":"49JON","./deleteQuiz.js":"hP6KI","./updatePassword.js":"nGra2","./updateMe.js":"bM8hf"}],"aVdmn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateQuiz", ()=>updateQuiz);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7nNen":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createQuiz", ()=>createQuiz);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const createQuiz = async (data)=>{
    try {
        ...
        console.log(res);
        if (res.status === "success") window.setTimeout(()=>{
            location.assign("/");
        }, 1500);
    } catch (err) {
        console.log(err);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5"}],"2Ax38":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "increseViewCount", ()=>increseViewCount);
const increseViewCount = async (id, csrfToken)=>{
    try {
        await fetch("/api/v1/quiz/" + id, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json"
            },
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7yHem":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hw7oM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "saveOnHistory", ()=>saveOnHistory);
const saveOnHistory = async (data, csrfToken)=>{
    try {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49JON":[function(require,module,exports) {
//eslint-disable
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hP6KI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "deleteQuiz", ()=>deleteQuiz);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const deleteQuiz = async (id, csrfToken)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "DELETE",
            url: "/api/v1/quiz/" + id,
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"nGra2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updatePassword", ()=>updatePassword);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const updatePassword = async (data, csrfToken)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bM8hf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hhrAs","f2QDv"], "f2QDv", "parcelRequireae0a")
